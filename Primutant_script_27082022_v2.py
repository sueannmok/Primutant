...
ecoli_dict={'F': ['TTT', 'TTC'], 'L': ['TTA', 'TTG', 'CTT', 'CTC', 'CTG'], 'I': ['ATT', 'ATC', ], 'M': ['ATG'], 'V': ['GTT', 'GTC', 'GTA', 'GTG'], 'S': ['TCT', 'TCC', 'TCA', 'AGT', 'AGC'], 'P': ['CCT', 'CCA', 'CCG'], 'T': ['ACT', 'ACC', 'ACA', 'ACG'], 'A': ['GCT', 'GCC', 'GCA', 'GCG'], 'Y': ['TAT', 'TAC'], 'Stop': ['TAA', 'TAG', 'TGA'], 'H': ['CAT', 'CAC'], 'Q': ['CAA', 'CAG'], 'N': ['AAT', 'AAC'], 'K': ['AAA', 'AAG'], 'D': ['GAT', 'GAC'], 'E': ['GAA', 'GAG'], 'C': ['TGT', 'TGC'], 'W': ['TGG'], 'R': ['CGT', 'CGC'], 'G': ['GGT', 'GGC', 'GGA', 'GGG']}
mammalian_dict={'F': ['TTT', 'TTC'], 'L': ['TTA', 'TTG', 'CTT', 'CTC', 'CTA', 'CTG'], 'I': ['ATT', 'ATC', 'ATA'], 'M': ['ATG'], 'V': ['GTT', 'GTC', 'GTA', 'GTG'], 'S': ['TCT', 'TCC', 'TCA', 'AGT', 'AGC'], 'P': ['CCT', 'CCC', 'CCA'], 'T': ['ACT', 'ACC', 'ACA'], 'A': ['GCT', 'GCC', 'GCA'], 'Y': ['TAT', 'TAC'], 'Stop': ['TAA', 'TAG', 'TGA'], 'H': ['CAT', 'CAC'], 'Q': ['CAA', 'CAG'], 'N': ['AAT', 'AAC'], 'K': ['AAA', 'AAG'], 'D': ['GAT', 'GAC'], 'E': ['GAA', 'GAG'], 'C': ['TGT', 'TGC'], 'W': ['TGG'], 'R': ['AGA', 'AGG'], 'G': ['GGT', 'GGC', 'GGA', 'GGG']}
...
def start_check():
    ...
    #allows user to input location without restarting program
        ...
        if start_codon !="ATG":
            ...
            print("this is not a start codon. Please try again")
        else:
            #print(start)
...
def create_output():
    ...
    with open(csv_name,'w',newline='') as f:
        ...
        thewriter.writerow(["sequence", seq])
...
def write_result(i, x, p, tmp2, tmp3, aa, mut, mut_num):
    ...
    # I don't think gcrev is needed - SM
